...
object AMRtoDTmapping {
  ...
  val s2 = Sentence(testData(3)._1, testData(3)._2)
                                                  ...
                                                  //| 0.3.0.2 -> date-entity, 0.3.0.1.0.0.0.0 -> "Estonia", ROOT -> ROOT, 0.2.0.0 
                                                  //| -> and, 0.3.0.1.0.0.0 -> name, 0.3.0.0.0 -> cyber),Map(0.1 -> (4,5), 0.0.0 -
                                                  //| > (1,2), 0.3.0.1.0.0 -> (15,16), 0.2.0.0.0 -> (12,13), 0.1.0 -> (3,4), 0.2.0
                                                  //| .0.1.0 -> (10,11), 0.3.0.2.0 -> (23,24), 0.0 -> (8,9), 0.0.0.0 -> (1,2), 0.2
                                                  //| .0 -> (6,7), 0.3.0.0 -> (21,22), 0.3.0 -> (18,19), 0.3 -> (13,14), 0.2.0.0.2
                                                  //|  -> (11,12), 0 -> (2,3), 0.3.0.1 -> (16,17), 0.2 -> (6,7), 0.3.0.2 -> (23,24
                                                  //| ), 0.3.0.1.0.0.0.0 -> (15,16), 0.2.0.0 -> (9,10), 0.3.0.1.0.0.0 ->
  ...
  val testDataFull = AMRGraph.importFile("C:\\AMR\\initialTrainingSetAmended.txt")
                                                  ...
                                                  //| ania (LT); United States (US),"(a / and :op1 (c / country :name (n / name :
                                                  //| op1 "Estonia")) :op2 (c2 / country :name (n3 / name :op1 "Latvia")) :op3 (c
                                                  //| 3 / country :name (n5 / name :op1 "Lithuania")) :op4 (c8 / country :name (n
                                                  //| 14 / name :op1 "United" :op2 "States"))) "), (International; Government; Te
                                                  //| lecom; technology; science,"(a / and :op1 (i / international) :op2 (g / gov
                                                  //| ernment-organization :ARG0-of (g2 / govern-01)) :op3 (t / telecommunication
                                                  //| ) :op4 (t2 / technology) :op5 (s / science)) "), (NATO CONSIDERS cyber atta
                                                  //| cks a threat to military and civilian computer networks after the Estonian 
                                                  //| Government was struck by cyber attacks in 2007.,"(c / consider-02 :ARG0 (m2
                                                  //|  / military :name (n / name :op1 "NATO")) :ARG1 (a / attack-01 :mod (c2 / c
                                                  //| yber)) :ARG2 (t / thing :ARG1-of (t2 / threaten-01 :ARG2 (a5 / and :op1 (n2
                                                  //|  / network :mod (m / military)) :op2 (n4 / network :mod (c3 / civilian)) :m
                                                  //| od (c4 / computer)))) :time (a3 / after :op1 (s / strike-01 :ARG0 (a4 / att
                                                  //| ack :mod (c6 / cyber)) :ARG1 (g / government-organization :ARG0-of (g2 / go
                                                  //| vern-01 :ARG1 (c5 / country :name (n3 / name :op1 "Estonia")))) :time (d / 
                                                  //| date-entity :year 2007)))) "), (NATO allies have signed an agreement to fun
                                                  //| d a research center to bolster defenses against cyber attacks.,"(s / sign-0
                                                  //| 1 :ARG0 (p / person :ARG0-of (a / ally-01) :mod (m / military :name (n / na
                                                  //| me :op1 "NATO"))) :ARG1 (a2 / agree-01 :ARG0 p :ARG1 (f / fund-01 :ARG0 p :
                                                  //| ARG1 (c / center :mod (r / research-01)) :purpose (b / bolster-01 :ARG0 p :
                                                  //| ARG1 (d / defend-01 :prep-against (a3 / attack :mod (c2 / cyber))))))) "), 
                                                  //| (On 14 May 2008 7 NATO allies signed an agreement to fund a research center
                                                  //| .,"(s / sign-01 :ARG0 (p / person :quant 7 :ARG0-of (a / ally-01) :mod (m /
                                                  //|  military :name (n / name :op1 "NATO"))) :ARG1 (a2 / agree-01 :ARG1 (f / fu
                                                  //| nd-01 :ARG0 p :ARG1 (c / center :mod (r / research-01)))) :time (d / date-e
                                                  //| ntity :month 5 :day 14 :year 2008)) "), (The center will bolster NATO's def
                                                  //| enses against cyber attacks.,"(b / bolster-01 :ARG0 (c / center) :ARG1 (d /
                                                  //|  defend-01 :ARG0 (m / military :name (n / name :op1 "NATO")) :ARG1 m :prep-
                                                  //| against (a / attack-01 :mod (c2 / cyber)))) "), (The center will 
                                                  //| Output exceeds cutoff limit.
