...
val testData = AMRGraph.importFile("C:\\AMR\\polarityExample.txt") // Nato Considers....
  ...
  val s1 = Sentence(testData(0)._1, testData(0)._2)
                                                  ...
                                                  //| InsertedNodes:	Map()
                                                  //| MergedNodes:	Map()
                                                  //| SwappedArcs:	Set(),Some(AMRGraph(Map(0.1 -> attack-01, 0.1.0 -> cyber
                                                  //| , 0.0 -> -, 0 -> precedent, ROOT -> ROOT),Map(0 -> (5,6), 0.1 -> (3,4), 0.1.
  ...
  val file = new FileWriter("C://AMR//polarity_output.txt")
                                                  //> file  : java.io.FileWriter = java.io.FileWriter@73e22a3d
  for (i <- 0 to 300) {
    if (!expertSystem.isTerminal(state)) {
      ...
      state = action(i)(state)
                                                  ...
                                                  //| Edges:	Map((3,2) -> mod, (5,3) -> nsubj, (5,6) -> -#)
                                                  ...
                                                  //|  -> -)
                                                  //| SpanMap:	Map(2 -> (2,3), 3 -> (3,4), 5 -> (5,6), 6 -> (5,6))
                                                  //| Edges:	Map((3,2) -> mod, (5,3) -> nsubj, (5,6) -> polarity)
                                                  //| InsertedNodes:	Map(6 -> 0.0)
                                                  //| MergedNodes:	Map()
                                                  //| SwappedArcs:	Set()
                                                  //| Mappings:	0 -> ROOT
                                                  ...
                                                  //|  -> -)
                                                  //| SpanMap:	Map(2 -> (2,3), 3 -> (3,4), 5 -> (5,6), 6 -> (5,6))
                                                  //| Edges:	Map((3,2) -> mod, (5,3) -> UNKNOWN, (5,6) -> polarity)
                                                  //| InsertedNodes:	Map(6 -> 0.0)
                                                  //| MergedNodes:	Map()
                                                  //| SwappedArcs:	Set()
                                                  //| Mappings:	0 -> ROOT
                                                  ...
                                                  //| NodeMap:	Map(0 -> ROOT, 2 -> cyber, 3 -> attack-01, 5 -> unprecedented, 6
                                                  //|  -> -)
                                                  //| SpanMap:	Map(2 -> (2,3), 3 -> (3,4), 5 -> (5,6), 6 -> (5,
  ...
  val outputAdv = RunDagger.sampleTrajectory(s1, "C:\\AMR\\WangXueExpert_output.txt", new WangXueExpert)
                                                  ...
                                                  //| InsertedNodes:	Map(6 -> 0.0)
                                                  //| MergedNodes:	Map()
                                                  //| SwappedArcs:	Set(),Some(AMRGraph(Map(5 -> unprecedented, 6 -> -, 0 ->
                                                  //|  ROOT, 2 -> cyber, 3 -> attack-01),Map(5 -> (5,6), 6 -> (5,6), 2 -> (2,3), 
                                                  //| 3 -> (3,4)),Map((3,2) -> mod, (5,3) -> UNKNOWN, (5,6) -> polarity))),Map(0 
                                                  //| -> ROOT, 5 -> 5, 6 -> 6, 2 -> 2, 3 -> 3))
